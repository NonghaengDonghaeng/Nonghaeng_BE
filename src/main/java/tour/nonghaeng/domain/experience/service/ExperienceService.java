...
public interface ExperienceService extends CrudService<Experience, CreateExpDto>, ViewService<ExpSummaryDto, ExpDetailDto, ExpSpecDto>, ManageCloseDateService<AddExpCloseDateDto>, LikesService<Experience> {
