...
public interface RoomService extends CrudService<Room, CreateRoomDto>, ViewService<RoomTourSummaryDto, RoomTourDetailDto, RoomSpecDto>, ManageCloseDateService<AddRoomCloseDateDto> {
