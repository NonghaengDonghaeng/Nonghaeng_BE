...
public class DummyDataWellService implements DummyDataService{
    ...
    public void setDummyData() throws IOException {
        ...
        Tour tour1 = tourService.create(seller1, createTourDto1);
        ...
        Experience experience1_1 = experienceService.create(seller1, createExpDto1_1);
        Experience experience1_2 = experienceService.create(seller1, createExpDto1_2);
        Experience experience1_3 = experienceService.create(seller1, createExpDto1_3);
        Experience experience1_4 = experienceService.create(seller1, createExpDto1_4);
        ...
        Room room1_1 = roomService.create(seller1, createRoomDto1_1);
        Room room1_2 = roomService.create(seller1, createRoomDto1_2);
        Room room1_3 = roomService.create(seller1, createRoomDto1_3);
        Room room1_4 = roomService.create(seller1, createRoomDto1_4);
        Room room1_5 = roomService.create(seller1, createRoomDto1_5);
        ...
        Tour tour2 = tourService.create(seller2, createTourDto2);
        ...
        Experience experience2_1 = experienceService.create(seller2, createExpDto2_1);
        Experience experience2_2 = experienceService.create(seller2, createExpDto2_2);
        ...
        Room room2_1 = roomService.create(seller2, createRoomDto2_1);
        Room room2_2 = roomService.create(seller2, createRoomDto2_2);


        //      ------------------이미지 자동 등록 --------------------- //

        //1번마을 이미지 등록
        photoServiceRegistry.getService(PhotoType.TOUR)
                .ifPresent(photoService -> {
                    try {
                        String[] imageFileTour = {"1_1.jpeg", "1_2.jpeg", "1_3.jpeg", "1_4.jpeg", "1_5.jpeg", "1_6.jpeg"};
                        photoService.uploads(seller1,tour1.getId(),loadStaticFilesAsMultipartFiles("tour", imageFileTour));
                    } catch (IOException e) {
        ...
        photoServiceRegistry.getService(PhotoType.EXPERIENCE)
                .ifPresent(photoService -> {
                    try {
                        String[] imageFileExp1_1 = {"1_1.jpeg"};
                        photoService.uploads(seller1,experience1_1.getId(),loadStaticFilesAsMultipartFiles("exp",imageFileExp1_1));
                    } catch (IOException e) {
                        throw new RuntimeException(e);
                    }
                });
        photoServiceRegistry.getService(PhotoType.EXPERIENCE)
                .ifPresent(photoService -> {
                    try {
                        String[] imageFileExp = {"2_1.jpeg","2_2.jpeg","2_3.jpeg","2_4.jpeg","2_5.jpeg","2_6.jpeg"};
                        photoService.uploads(seller1,experience1_2.getId(),loadStaticFilesAsMultipartFiles("exp", imageFileExp));
                    } catch (IOException e) {
                        throw new RuntimeException(e);
                    }
                });
        photoServiceRegistry.getService(PhotoType.EXPERIENCE)
                .ifPresent(photoService -> {
                    try {
                        String[] imageFileExp = {"3_1.jpeg","3_2.jpeg"};
                        photoService.uploads(seller1,experience1_3.getId(),loadStaticFilesAsMultipartFiles("exp", imageFileExp));
                    } catch (IOException e) {
                        throw new RuntimeException(e);
                    }
                });
        photoServiceRegistry.getService(PhotoType.EXPERIENCE)
                .ifPresent(photoService -> {
                    try {
                        String[] imageFileExp = {"4_1.jpeg","4_2.jpeg","4_3.jpeg","4_4.jpeg","4_5.jpeg","4_6.jpeg"};
                        photoService.uploads(seller1,experience1_4.getId(),loadStaticFilesAsMultipartFiles("exp", imageFileExp));
                    } catch (IOException e) {
                        throw new RuntimeException(e);
                    }
                });
        ...
        photoServiceRegistry.getService(PhotoType.ROOM)
                .ifPresent(photoService -> {
                    try {
                        String[] imageFiles = {"1_1.jpeg","1_2.jpeg","1_3.jpeg","1_4.jpeg","1_5.jpeg","1_6.jpeg"};
                        photoService.uploads(seller1, room1_1.getId(), loadStaticFilesAsMultipartFiles("room", imageFiles));
                    } catch (IOException e) {
                        throw new RuntimeException(e);
                    }
                });
        photoServiceRegistry.getService(PhotoType.ROOM)
                .ifPresent(photoService -> {
                    try {
                        String[] imageFiles = {"2_1.jpeg","2_2.jpeg","2_3.jpeg","2_4.jpeg","2_5.jpeg"};
                        photoService.uploads(seller1, room1_2.getId(), loadStaticFilesAsMultipartFiles("room", imageFiles));
                    } catch (IOException e) {
                        throw new RuntimeException(e);
                    }
                });
        photoServiceRegistry.getService(PhotoType.ROOM)
                .ifPresent(photoService -> {
                    try {
                        String[] imageFiles = {"3_1.jpeg","3_2.jpeg","3_3.jpeg","3_4.jpeg","3_5.jpeg"};
                        photoService.uploads(seller1, room1_3.getId(), loadStaticFilesAsMultipartFiles("room", imageFiles));
                    } catch (IOException e) {
                        throw new RuntimeException(e);
                    }
                });
        photoServiceRegistry.getService(PhotoType.ROOM)
                .ifPresent(photoService -> {
                    try {
                        String[] imageFiles = {"4_1.jpeg","4_2.jpeg","4_3.jpeg","4_4.jpeg","4_5.jpeg"};
                        photoService.uploads(seller1, room1_4.getId(), loadStaticFilesAsMultipartFiles("room", imageFiles));
                    } catch (IOException e) {
                        throw new RuntimeException(e);
                    }
                });
        photoServiceRegistry.getService(PhotoType.ROOM)
                .ifPresent(photoService -> {
                    try {
                        String[] imageFiles = {"5_1.jpeg","5_2.jpeg"};
                        photoService.uploads(seller1, room1_5.getId(), loadStaticFilesAsMultipartFiles("room", imageFiles));
                    } catch (IOException e) {
                        throw new RuntimeException(e);
                    }
                });
        ...
        photoServiceRegistry.getService(PhotoType.TOUR)
                .ifPresent(photoService -> {
                    try {
                        String[] imageFileTour = {"2_1.jpeg", "2_2.jpeg", "2_3.jpeg", "2_4.jpeg", "2_5.jpeg", "2_6.jpeg"};
                        photoService.uploads(seller2,tour2.getId(),loadStaticFilesAsMultipartFiles("tour",imageFileTour));
                    } catch (IOException e) {
                        throw new RuntimeException(e);
                    }
                });
        ...
        photoServiceRegistry.getService(PhotoType.EXPERIENCE)
                .ifPresent(photoService -> {
                    try {
                        String[] imageFileExp = {"5_1.jpeg","5_2.jpeg","5_3.jpeg"};
                        photoService.uploads(seller2,experience2_1.getId(),loadStaticFilesAsMultipartFiles("exp",imageFileExp));
                    } catch (IOException e) {
                        throw new RuntimeException(e);
                    }
                });
        photoServiceRegistry.getService(PhotoType.EXPERIENCE)
                .ifPresent(photoService -> {
                    try {
                        String[] imageFileExp = {"6_1.jpeg","6_2.jpeg","6_3.jpeg","6_4.jpeg","6_5.jpeg"};
                        photoService.uploads(seller2,experience2_2.getId(),loadStaticFilesAsMultipartFiles("exp",imageFileExp));
                    } catch (IOException e) {
                        throw new RuntimeException(e);
                    }
                });
        ...
        photoServiceRegistry.getService(PhotoType.ROOM)
                .ifPresent(photoService -> {
                    try {
                        String[] imageFiles = {"6_1.jpeg","6_2.jpeg","6_3.jpeg","6_4.jpeg","6_5.jpeg","6_6.jpeg"};
                        photoService.uploads(seller2, room2_1.getId(), loadStaticFilesAsMultipartFiles("room", imageFiles));
                    } catch (IOException e) {
                        throw new RuntimeException(e);
                    }
                });
        photoServiceRegistry.getService(PhotoType.ROOM)
                .ifPresent(photoService -> {
                    try {
                        String[] imageFiles = {"7_1.jpeg","7_2.jpeg","7_3.jpeg","7_4.jpeg","7_5.jpeg"};
                        photoService.uploads(seller2, room2_2.getId(), loadStaticFilesAsMultipartFiles("room",imageFiles));
                    } catch (IOException e) {
                        throw new RuntimeException(e);
                    }
                });
    ...
    private List<MultipartFile> loadStaticFilesAsMultipartFiles(String type,String[] imageFileNames) throws IOException {
        ...
        for (String fileName : imageFileNames) {
            ...
            String resourcePath = "static/images/" + type + "/" + fileName;
