...
## TODOLIST
- photo: PhotoController 완전히 통합하기 위해 seller,user를 member를 상속하여 묶기
- review: 리뷰 부분도 인터페이스 도입과 registry로 통합하기 그런데 서로다른 createdto를 사용하고 return 값도 달라서 고민중
...
- 사진을 따로 업로드말고 동시에 업로드가능하도록 수정해보기(현재는 따로 업로드해야됨)
## 내일할것(오늘 4/9)
- oauth 로그인(구글,네이버)
- 상세조회시 여러 카테고리 선택하기
- 테스트작성할거 작성하기
